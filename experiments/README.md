...
# results-02.csv
./run-all.py --num-bad 1 --num-good 1 --timeout 2 --no-full --force-unsat
...
# results-05.csv
./run-all.py --num-bad 1 --num-good 3 --timeout 30 --no-full --expand-indices

# Jul 9 at 8pm MT (above results are outdated):

# results-06.csv
./run-all.py --num-bad 1 --num-good 1 --timeout 30 --repeats 3

# results-07.csv
./run-all.py --num-bad 1 --num-good 1 --timeout 30 --repeats 3

# results-08.csv
./run-all.py --num-bad 1 --num-good 1 --timeout 30 --repeats 3 --no-full

# results-09.csv
./run-all.py --num-bad 1 --num-good 2 --timeout 30 --repeats 3 --no-full

# results-10.csv
./run-all.py --num-bad 1 --num-good 3 --timeout 30 --repeats 3 --no-full

# results-11.csv
./run-all.py --num-bad 1 --num-good 1 --timeout 2 --no-full --force-unsat

# results-12.csv
./run-all.py --num-bad 1 --num-good 1 --timeout 10 --no-full --force-unsat
```
